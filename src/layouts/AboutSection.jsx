...
export default function AboutSection() {
  return (
    <section className="flex bg-blue-950 bg-pattern-circles bg-no-repeat bg-bottom md:bg-bottom bg-left justify-center rounded-tr-[5rem] rounded-bl-[5rem] mt-44 pb-20 md:pb-0 w-full">
